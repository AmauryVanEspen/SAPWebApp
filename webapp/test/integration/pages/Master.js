				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "BusinessPartnerCollection (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'BusinessPartnerCollection (0)'");
							},
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "BusinessPartnerCollection (" + iExpectedLength + ")"}),
									success : function () {
