sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/test/teched/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.test.teched.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/test/teched/localService/mockserver"], function (mockserver) {
